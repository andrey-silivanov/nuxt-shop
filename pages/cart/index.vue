                        ...
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                            <div class="wrap-table-shopping-cart">
                                <table class="table-shopping-cart">
                                    ...
                                    <tr class="table_row" v-for="product in cartProducts" :key="product.id">
                                        <td class="column-1">
                                        ...
                                        <td class="column-4">
                                            <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m"
                                                     @click="decrementCountProduct(product)" v-if="product.count > 1">
                                                ...
                                                <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" :value="product.count">

                                                <div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m"
                                                    @click="incrementCountProduct(product)"
                                                >
                                                    <i class="fs-16 zmdi zmdi-plus"></i>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="column-5">$ {{ subtotal(product) }}</td>
                                    </tr>
